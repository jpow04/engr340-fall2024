...
for word in words:
    ...
    # starts with vowel, append "vay" and put in list
    elif starts_with_vowel(word) == True:
        # modify the word and place in pig_latin list
        pig_latin.append(word + 'vay')
        continue

    # starts with consonant, place starting letter on tail and append "ay" and put in list
    else:
        # modify word and place in pig_latin list
        starting_letter = word[0]  # Get starting letter
        pig_latin.append(word[1:] + starting_letter + 'ay')
        continue
